...
| 文件 | 类名 | 说明 |
|------|------|------|
| `Force_Node.h` | `Force_Node` | 节点集中力荷载 |
...
```
*LOAD, FORCE_NODE, 数量
ID(荷载编号)  NodeID(节点编号)  Direction(荷载方向)  Value(荷载大小)
```
...
```
*LOAD, FORCE_NODE, 3
1   2   0   10000     ** 节点2：X方向 +10kN (FX=10000N)
2   2   1   -5000     ** 节点2：Y方向 -5kN (FY=-5000N)
3   3   2   -20000    ** 节点3：Z方向 -20kN (FZ=-20000N，向下)
```
...
文件：[Import/AeroManager.h](YQY/Import/AeroManager.h)
