...
/** 从空间姿态中提取绕指定轴的 swing-twist 扭转角。 */
double ExtractAxialTwist(const Eigen::Matrix3d& rotation, const Eigen::Vector3d& axis);
...
/**
        ...
        */
void Update_NodalRotation(const Eigen::Vector3d& delta_theta, const Eigen::Matrix3d& R_old,
                          _OUT Eigen::Matrix3d& R_new);
